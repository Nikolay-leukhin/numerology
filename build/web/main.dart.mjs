...
_1691: () => Date.now(),
_1693: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1696: (x0,x1) => x0.send(x1),
_1702: f => finalizeWrapper(f,x0 => dartInstance.exports._1702(f,x0)),
_1703: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1704: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1722: () => new XMLHttpRequest(),
_1723: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1725: x0 => x0.getAllResponseHeaders(),
_1726: (a, i) => a.push(i),
_1730: a => a.pop(),
...
_1928: (x0,x1) => x0.withCredentials = x1,
_1930: x0 => x0.responseURL,
_1931: x0 => x0.status,
_1932: x0 => x0.statusText,
_1934: (x0,x1) => x0.responseType = x1,
_1935: x0 => x0.response,
_14727: () => globalThis.window,
_14748: x0 => x0.matches,
_14752: x0 => x0.platform,
_14757: x0 => x0.navigator
    };
